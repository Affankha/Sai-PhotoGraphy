...
export const projects = [
  {
    ...
    src: "/Album.jpg",
    // https://img.freepik.com/premium-vector/instant-element-photo-frames-collage-with-realistic-design-premium-vector_609667-166.jpg?w=826
  },
  {
    title: "Photos & Camera",
    description:
  ...
  },
  {
    title: "crane",
    description:
      "High-Angle & Sweeping Shots: We use the crane to capture grand, cinematic shots — like the entire stage, crowd, or entrance from above. It adds a film-like quality to your wedding video.",
    src: "/crane.jpg",
    // https://img.freepik.com/premium-photo/flying-mobile-drone-sky-with-mountain-range-sunset_302321-6007.jpg?w=740
  },
  {
    title: "Event Shoot",
    description:
      "Photography (Still Shots):Capturing candid, posed, and documentary-style photos of all key moments.From bridal makeup, rituals, guests, couple portraits, décor, food, etc. Edited digital albums and prints often included.",
    src: "/img-1.jpeg",
  },
  {
    title: "LED Display",
    description:
      "a welcome LED screen with the couple’s names and a glowing floral animation creates a stunning entrance shot. During the ceremony or reception, live footage displayed on LED panels allows guests at the back to witness emotional moments up close.",
    src: "/live-01.jpg",
  },
];
